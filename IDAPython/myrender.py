...
def color_trace(old_sample_num):
    ...
    # read trace file
    f_trace = open('%d-addrs.txt'%old_sample_num,'r')
...
def insert_task(old_sample_num):
    ...
    for line in f_taint.readlines():
        ...
        sql_cmd='INSERT INTO task(old_sample_num,new_sample_num,convert_address,status) VALUES('+str(old_sample_num)+','+str(g_new_num)+','+str(convert_addr)+','+str(0)+');'
