...
ASSERT(
0bin1 =
(LET mem32_array_108_0 = (mem32_array_108 WITH [0hexbfef3c09] := symb_1_109) IN
(LET mem32_array_108_1 =
                          (mem32_array_108_0 WITH [0hexbfef3c0a] := symb_2_110)
                          IN
(LET mem32_array_108_2 =
                          (mem32_array_108_1 WITH [0hexbfef3c0b] := symb_3_111)
                          IN
(LET mem32_array_108_3 =
                          (mem32_array_108_2 WITH [0hexbfef3c0c] := symb_4_112)
                          IN
(LET mem32_array_108_4 =
                          (mem32_array_108_3 WITH [0hexbfef3c0d] := symb_5_113)
                          IN
((0bin1&IF (0hexbfef3c0d=0hexbfef3c0d) THEN 0bin1 ELSE 0bin0 ENDIF)&
((0bin1&IF (0hexbfef3c0c=0hexbfef3c0c) THEN 0bin1 ELSE 0bin0 ENDIF)&
((0bin1&IF (0hexbfef3c0b=0hexbfef3c0b) THEN 0bin1 ELSE 0bin0 ENDIF)&
((0bin1&IF (0hexbfef3c0a=0hexbfef3c0a) THEN 0bin1 ELSE 0bin0 ENDIF)&
((0bin1&IF (0hexbfef3c09=0hexbfef3c09) THEN 0bin1 ELSE 0bin0 ENDIF)&
((0bin1&IF (0hexbfef3c09=0hexbfef3c09) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET R_EAX_32_11_5 = 0hex00000061 IN
(LET R_ESP_32_3_6 = 0hexbfef3bf0 IN
((0bin1&
 IF (0hexbfef3c09=
...
(~(R_ZF_23_24)&
((0bin1&IF (0hexbfef3c0a=0hexbfef3c0a) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET R_ESP_32_3_27 = 0hexbfef3bf0 IN
((0bin1&
 IF (0hexbfef3c0a=
...
(R_ZF_23_38&
((0bin1&IF (0hexbfef3c0b=0hexbfef3c0b) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET R_ESP_32_3_41 = 0hexbfef3bf0 IN
((0bin1&
 IF (0hexbfef3c0b=
...
(R_ZF_23_52&
((0bin1&IF (0hexbfef3c0c=0hexbfef3c0c) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET R_ESP_32_3_55 = 0hexbfef3bf0 IN
((0bin1&
 IF (0hexbfef3c0c=
...
(R_ZF_23_66&
((0bin1&IF (0hexbfef3be2=0hexbfef3be2) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_69 = (mem32_array_108_4 WITH [0hexbfef3be2] := 0hexef) IN
((0bin1&IF (0hexbfef3be3=0hexbfef3be3) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_70 = (mem32_array_108_69 WITH [0hexbfef3be3] := 0hexbf) IN
((0bin1&IF (0hexbfef3be0=0hexbfef3be0) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_71 = (mem32_array_108_70 WITH [0hexbfef3be0] := 0hex08) IN
((0bin1&IF (0hexbfef3be1=0hexbfef3be1) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_72 = (mem32_array_108_71 WITH [0hexbfef3be1] := 0hex3c) IN
(LET R_ESP_32_3_73 = 0hexbfef3be4 IN
...
((0bin1&IF (0hexbfef3be6=0hexbfef3be6) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_83 = (mem32_array_108_76 WITH [0hexbfef3be6] := 0hex7f) IN
((0bin1&IF (0hexbfef3be7=0hexbfef3be7) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_84 = (mem32_array_108_83 WITH [0hexbfef3be7] := 0hexb7) IN
((0bin1&IF (0hexbfef3be4=0hexbfef3be4) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_85 = (mem32_array_108_84 WITH [0hexbfef3be4] := 0hex38) IN
((0bin1&IF (0hexbfef3be5=0hexbfef3be5) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_86 = (mem32_array_108_85 WITH [0hexbfef3be5] := 0hexd9) IN
(LET R_ESP_32_3_87 = 0hexbfef3bd8 IN
(((((0bin1&
    IF (0hexbfef3be7=
...
(LET R_EAX_32_11_88 =
                       ...
                       (((T_loadnorm_133_89[0hexbfef3be7]@T_loadnorm_133_89[
                                                          0hexbfef3be6])@
                        T_loadnorm_133_89[0hexbfef3be5])@T_loadnorm_133_89[
                                                         0hexbfef3be4]))
                       IN
(LET R_DF_26_90 = 0bin0 IN
(LET R_ESP_32_3_91 = 0hexbfef3bc4 IN
...
((0bin1&IF (0hexbfef3be0=0hexbfef3be0) THEN 0bin1 ELSE 0bin0 ENDIF)&
((0bin1&IF (0hexbfef3be1=0hexbfef3be1) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET R_EAX_32_11_102 = 0hex9d278190 IN
(LET R_ESP_32_3_103 = 0hexbfef3bdc IN
(((((0bin1&
    IF (0hexbfef3be3=
...
(LET R_EAX_32_11_104 =
                        ...
                        (((T_loadnorm_140_137_105[0hexbfef3be3]@T_loadnorm_140_137_105[
                                                                0hexbfef3be2])@
                         T_loadnorm_140_137_105[0hexbfef3be1])@T_loadnorm_140_137_105[
                                                               0hexbfef3be0]))
                        IN
((0bin1&IF (0hexbfef3be2=0hexbfef3be2) THEN 0bin1 ELSE 0bin0 ENDIF)&
((0bin1&IF (0hexbfef3be3=0hexbfef3be3) THEN 0bin1 ELSE 0bin0 ENDIF)&
...
(LET R_ESP_32_3_107 = 0hexbfef3be4 IN
...
((0bin1&IF (0hexbfef3bf3=0hexbfef3bf3) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_117 =
                            (mem32_array_108_110 WITH [0hexbfef3bf3] := 
                            0hex08) IN
((0bin1&IF (0hexbfef3bf1=0hexbfef3bf1) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_118 =
                            (mem32_array_108_117 WITH [0hexbfef3bf1] := 
                            0hex87) IN
((0bin1&IF (0hexbfef3bf2=0hexbfef3bf2) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_119 =
                            (mem32_array_108_118 WITH [0hexbfef3bf2] := 
                            0hex04) IN
((0bin1&IF (0hexbfef3bf0=0hexbfef3bf0) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_120 =
                            (mem32_array_108_119 WITH [0hexbfef3bf0] := 
                            0hex59) IN
(LET R_ESP_32_3_121 = 0hexbfef3bc0 IN
(((((0bin1&
    IF (0hexbfef3bf3=
...
(LET R_EAX_32_11_122 =
                        ...
                        (((T_loadnorm_144_145_123[0hexbfef3bf3]@T_loadnorm_144_145_123[
                                                                0hexbfef3bf2])@
                         T_loadnorm_144_145_123[0hexbfef3bf1])@T_loadnorm_144_145_123[
                                                               0hexbfef3bf0]))
                        IN
((0bin1&IF (0hexbfef3c0e=0hexbfef3c0e) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_124 =
                            (mem32_array_108_120 WITH [0hexbfef3c0e] := 
                            0hex67) IN
((0bin1&IF (0hexbfef3c0c=0hexbfef3c0c) THEN 0bin1 ELSE 0bin0 ENDIF)&
((0bin1&IF (0hexbfef3c0f=0hexbfef3c0f) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET mem32_array_108_125 =
                            (mem32_array_108_124 WITH [0hexbfef3c0f] := 
                            0hex68) IN
((0bin1&IF (0hexbfef3c0d=0hexbfef3c0d) THEN 0bin1 ELSE 0bin0 ENDIF)&
(LET R_EBP_32_1_126 = 0hexbfef3c48 IN
(LET R_EAX_32_11_127 = 0hexbfef3c64 IN
(((((0bin1&
    IF (0hexbfef3c0c=
