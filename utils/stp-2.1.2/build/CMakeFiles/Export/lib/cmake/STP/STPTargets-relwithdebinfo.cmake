...
set_target_properties(libstp PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELWITHDEBINFO "/usr/lib/i386-linux-gnu/libboost_program_options.so;/usr/local/lib/libminisat.so"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libstp.so.2.1.2"
  IMPORTED_SONAME_RELWITHDEBINFO "libstp.so.2.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS libstp )
list(APPEND _IMPORT_CHECK_FILES_FOR_libstp "${_IMPORT_PREFIX}/lib/libstp.so.2.1.2" )
